...
public class UserController {
    ...
    @PostMapping("/adopt")
    public User adoptPet(@RequestParam("user_id") Long userId, @RequestParam("pet_id") Long petId) {
    ...
    @PostMapping("/return")
    public User returnPet(@RequestParam("user_id") Long userId, @RequestParam("pet_id") Long petId) {
        User user = findUserById(userId);
        Pet pet = petService.findPetById(petId);
